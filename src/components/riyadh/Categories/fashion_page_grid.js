...
class fashion_page_grid extends Component {
    ...
    constructor(props) {
      ...
      componentDidMount() {
        fetch("https://jeddah-bats.herokuapp.com/Products?city=%D8%A7%D9%84%D8%B1%D9%8A%D8%A7%D8%B6&cat=%D8%A3%D8%B2%D9%8A%D8%A7%D8%A1")
          .then(res => res.json())
          .then(
            (result) => {
              this.setState({
...
export default fashion_page_grid;