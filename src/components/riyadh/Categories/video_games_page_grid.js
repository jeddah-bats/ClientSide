...
class video_games_page_grid extends Component {
    ...
    constructor(props) {
      ...
      componentDidMount() {
        fetch("https://jeddah-bats.herokuapp.com/Products?city=%D8%A7%D9%84%D8%B1%D9%8A%D8%A7%D8%B6&cat=%D8%A7%D9%84%D8%B9%D8%A7%D8%A8%20%D9%81%D9%8A%D8%AF%D9%8A%D9%88")
          .then(res => res.json())
          .then(
            (result) => {
              this.setState({
...
export default video_games_page_grid;